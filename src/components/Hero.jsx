  ...
  return (
    <main>
      <section className="bg-[#3DC3E4] text-center min-h-screen flex flex-col items-center pt-10 md:pt-2">
        <div className="text-[#FFFFFF] w-[90%] md:w-[69%] mx-auto">
          <h1 className="text-[30px] md:text-[54px] font-bold mb-6 text-center uppercase font-extrabold leading-[50px] md:leading-[90px]">
        ...
        <div className="mt-[80px] md:mt-10">
          <Link
            to="/signup"
